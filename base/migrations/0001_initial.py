...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Etablissement',
            fields=[
                ('numero_uai', base.uppercasecharfield.Lettre23Field(length=8, primary_key=True, serialize=False, unique=True, verbose_name='UAI')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ine', base.uppercasecharfield.Lettre23Field(length=11, verbose_name="INE (numéro d'étudiant)")),
