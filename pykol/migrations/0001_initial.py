# Generated by Django 2.1 on 2018-08-25 06:24
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Academie',
            fields=[
                ('id', models.PositiveSmallIntegerField(primary_key=True, serialize=False, verbose_name='numéro')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_paiement', models.DateTimeField(blank=True, help_text='Date où toutes les colles de ce relevé ont été mises en paiement.', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('salle', models.CharField(blank=True, max_length=30)),
                ('colles_ens', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='pykol.CollesEnseignement')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='filles', to='pykol.Matiere')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('annee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='pykol.Annee', verbose_name='année')),
            ],
        ),
        migrations.CreateModel(
            name='Vacances',
            fields=[
                ...
                ('debut', models.DateField(verbose_name='début')),
                ('fin', models.DateField()),
                ('type_vacances', models.PositiveSmallIntegerField(choices=[(1, 'vacances'), (2, 'férié')], default=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('disciplines', models.ManyToManyField(to='pykol.Discipline')),
        ...
        migrations.AddField(
            model_name='dotationclasseligne',
            name='enseignement',
        ...
        migrations.AddField(
            model_name='colle',
            name='groupe',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='pykol.Trinome'),
        ),
        migrations.AddField(
            model_name='colle',
            name='releve',
        ...
        migrations.AddField(
            model_name='groupeeffectif',
            name='classe',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='+', to='pykol.Classe'),
        ),
        migrations.AddField(
            model_name='groupe',
        ...
        migrations.AddField(
            model_name='dotationclasseligne',
            name='dotation_classe',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='pykol.DotationClasse'),
        ),
    ]
