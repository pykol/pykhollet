...
class Migration(migrations.Migration):
	...
	operations = [
		...
		migrations.RunPython(rattache_classe_etablissement, reverse_rattache_classe_etablissement, elidable=True),
		...
		migrations.RunPython(rattache_collereleve_etablissement, reverse_rattache_collereleve_etablissement, elidable=True),
		migrations.AlterField(
			model_name='collereleve',
			name='etablissement',
			field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='pykol.Etablissement'),
