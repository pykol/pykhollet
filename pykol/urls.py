...
colloscopes_urlpatterns = [
	...
	path('<slug:slug>/calendrier/matiere-<int:matiere_pk>/', views.colloscope.CalendrierMatiereView.as_view(), name='colloscope_calendrier_matiere'),
	path('<slug:slug>/calendrier/matiere-<int:matiere_pk>/colleur-<int:colleur_pk/', views.colloscope.CalendrierMatiereColleurView.as_view(), name='colloscope_calendrier_matiere_colleur'),
